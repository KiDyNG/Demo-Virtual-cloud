...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Chi tiết sản phẩm | ECCO</title>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="reviews" class="container tab-pane fade">
                                        <div class="reviews-submitted">
                                            <div class="reviewer">Anh Nguyễn Kiến Duy  - <span>1-4-2023</span></div><br>
                                            <p> Rất hài lòng về thái độ phục vụ, nhân viên luôn có thái độ vui vẻ, nhiệt tình, đáp ứng mọi nhu cầu khi khách hàng yêu cầu cách chăm sóc và trợ giúp mỗi khi cần. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="product">
                            ...
                            <div class="row align-items-center product-slider product-slider-3">
                               ...
                               <?php 
                                    ...
                                    $ecco = mysqli_query($ket_noi, $sql);

                                    while ($row = mysqli_fetch_array($ecco))
                                    {
                                ;?>
                                <div class="col-lg-3">
