...
<html lang="en">
   ...
   <p class="hnc-static-text"><strong>Chất lượng hàng hóa</strong> là mối quan tâm số một của khách hàng khi quyết định mua sản phẩm, thấu hiểu sự trăn trở này, AWEB luôn luôn đảm bảo những sản phẩm do công ty chúng tôi kinh doanh, cung cấp, phân phối đều là mặt hàng chính hãng với chất lượng được cam kết ở mức cao nhất.</p>

   <p class="hnc-static-text">Một trong những yếu tố để AWEB có thể cung cấp xuyên suốt các sản phẩm có chất lượng chính hãng chính là vì chúng tôi chỉ hợp tác với các đối tác uy tín, đáng tin cậy.</p>
   ...
   <p class="hnc-static-text">Cam kết này được đưa ra nhằm thực hiện sứ mệnh mang đến các sản phẩm chất lượng chính hãng cùng sự hài lòng ở mức cao nhất cho khách hàng khi trải nghiệm dịch vụ của AWEB.</p>
</div>
