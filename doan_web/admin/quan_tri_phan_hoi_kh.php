...
<html lang="en">
    <head>
        ...
        <title>Quản trị phản hồi của khách hàng</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="quan_tri_he_thong.html">ECCO</a>
            <!-- Sidebar Toggle-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Quản trị phản hồi của khách hàng</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="quan_tri_he_thong.php">Quản trị hệ thống</a></li>
                            <li class="breadcrumb-item active">Quản trị sản phản hồi khách hàng</li>
                        </ol>
                        <div class="card mb-4">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th style="text-align: center;">Ngày gửi</th>
                                            <th style="text-align: center;">Nội dung phản hồi</th>
                                            <th style="text-align: center;">Xóa</a></th>
                                        </tr>
                                    </tfoot>
                                    <tbody>
                   ...
                   $sql = "
                    ...
                    $i = 0;
                    while ($row = mysqli_fetch_array($noi_dung_phan_hoi)) 
                    {
                        $i++
                    ;?>                
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><?php echo $row['ngaygui'] ;?></td>
                        <td><?php echo $row['noidung'] ;?></td>
                        <td style="text-align: center;"><a href="phan_hoi_xoa.php?id=<?php echo $row['mabinhluan'] ;?>"><button type="submit" class="btn btn-primary btn-block">Xóa</button></a></td>
                    </tr>
