                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="quan_tri_hinh_thuc_thanh_toan.php">Quản trị hình thức thanh toán</a></li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                              ...
                              <?php
                                ...
                                $sql = "
                                        SELECT *  
                                        FROM thanhtoan 
                                        WHERE mathanhtoan = ".$thanh_toan_id."
                                ...
                                $row = mysqli_fetch_array($noi_dung_thanh_toan);
                    
                              ;?> 
                                <form method="POST" action="thanh_toan_sua_thuc_hien.php" enctype="multipart/form-data">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtHinhThucTT" name="txtHinhThucTT" placeholder="Hình thức thanh toán" value="<?php echo $row['hinhthuctt'] ;?>" />
                                        <label for="txtHinhThucTT">Hình thức thanh toán</label>
                                     </div>
                                    <div class="form-floating mb-3">
                                        <textarea class="form-control" id="txtGhiChuTT" name="txtGhiChuTT" placeholder="Ghi chú"><?php echo $row['ghichutt'] ;?></textarea>
                                        <label for="txtGhiChuTT">Ghi chú</label>
                                    </div>
                                    <div class="mt-4 mb-0">
                                        <input type="hidden" name="txtIDTT" value="<?php echo $row['mathanhtoan'] ;?>">
                                        <div class="d-grid"><button type="submit" class="btn btn-primary btn-block">SỬA HÌNH THỨC THANH TOÁN</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
