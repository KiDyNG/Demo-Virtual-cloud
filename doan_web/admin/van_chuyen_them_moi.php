                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form method="POST" action="van_chuyen_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtHinhThucVC" name="txtHinhThucVC" placeholder="Hình thức vận chuyển" />
                                        <label for="txtHinhThucVC">Hình thức vận chuyển</label>
                                     </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtGiaCuocVC" name="txtGiaCuocVC" placeholder="Giá cước vận chuyển">
                                        <label for="txtGiaCuocVC">Giá cước vận chuyển</label>
                                    </div>
                                    <div class="mt-4 mb-0">
                                        <div class="d-grid"><button type="submit" class="btn btn-primary btn-block">Thêm hình thức vận chuyển</button></div>
                                    </div>
                                </form>
                            </div>
                        </div>
