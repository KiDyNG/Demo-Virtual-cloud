                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="dodabong.php" class="nav-item nav-link active">ĐỒ ĐÁ BÓNG</a>
        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">ĐỒ ĐÁ BÓNG</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <?php 
                                ...
                                $laptop_moi = mysqli_query($ket_noi, $sql);

                                # Hiển thị ra CSDL mà bạn vừa mới lấy được
                                while ($row = mysqli_fetch_array($laptop_moi))
                                {
                            ;?>                           
                            <div class="col-md-4">
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                        <img src="<?php echo $row['anhdaidien'] ? 'img_sp/'.$row['anhdaidien'] : 'img_sp/acer1.jpg' ;?>" alt="Ảnh sản phẩm">
                                    </div>
                        ...
                        <div class="sidebar-widget widget-slider">
                            <div class="sidebar-slider normal-slider">
                                <?php 
                                    ...
                                    $list_laptop_moi = mysqli_query($ket_noi, $sql);

                                    while ($row = mysqli_fetch_array($list_laptop_moi))
                                    {
                                ;?>
                                <div class="product-item">
                                    <div class="product-title">
