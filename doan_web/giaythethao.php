...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>GIÀY THỂ THAO | ECCO</title>
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="giaythethao.php" class="nav-item nav-link active">GIÀY THỂ THAO</a>
                        ...
                        <div class="sidebar-widget widget-slider">
                            <div class="sidebar-slider normal-slider">
                                <?php 
                                    ...
                                    $list_laptop_do_hoa_gaming = mysqli_query($ket_noi, $sql);

                                    while ($row = mysqli_fetch_array($list_laptop_do_hoa_gaming))
                                    {
                                ;?>
                                <div class="product-item">
                                    <div class="product-title">
