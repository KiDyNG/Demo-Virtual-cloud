...
<html lang="en">
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link active " id="password" href="password.php" data-toggle="pill" href="#password-tab" role="tab" aria-selected="true" >Mật khẩu</a>
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                           ...
                           $sql = "
                            ...
                            ;?>
                            <div class="tab-pane fade active show " id="password-tab" >
                                <h4>THAY ĐỔI MẬT KHẨU</h4>
                                <form action="thay_doi_password.php" method="POST" enctype="multipart/form-data" onsubmit="return kiem_tra_mat_khau();">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <input class="form-control" type="password" id="txtMatkhaucu" name="txtMatkhaucu" placeholder="Mật khẩu cũ">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-9">
                                            <input class="form-control" type="password" id="txtMatkhaumoi" name="txtMatkhaumoi" placeholder="Mật khẩu mới">
                                        </div>
                                        <div class="col-md-9">
                                            <input class="form-control" type="password" id="txtNhaplaimk" placeholder="Nhập lại mật khẩu mới">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
        ...
        function kiem_tra_mat_khau() {
            ...
            var nhaplaimk = document.getElementById('txtNhaplaimk').value;
           
            // Kiểm tra xem ô mật khẩu cũ đã nhập thông tin chưa
            if (matkhaucu == '')
            {
            ...
            // Kiểm tra xem ô mật khẩu mới đã nhập thông tin hay chưa
            else if (matkhaumoi == '')
            {
