...
<html lang="en">
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link active " id="email" href="email.php" data-toggle="pill" href="#email-tab" role="tab" aria-selected="true" >Email</a>
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="tab-content">
                           ...
                           $sql = "
                            ...
                            <div class="tab-pane fade active show " id="email-tab" >
                                ...
                                <form action="thay_doi_email.php" method="POST" enctype="multipart/form-data" onsubmit="return kiem_tra();">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>Email:</label>
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="email" id="txtEmail" name="txtEmail" placeholder="Email" readonly="true" value="<?php echo $row['email'];?>">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" type="email" id="txtEmailmoi" name="txtEmailmoi" placeholder="Email mới" >
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label class="mk">Mật khẩu:</label>
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="password" id="txtMatkhau"  name="txtMatkhau" placeholder="Nhập mật khẩu">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <input type="hidden" name="txtIDthanhvien" value="<?php echo $row['mathanhvien'] ;?>">
                                            <button class="btn" name="xac_nhan" onclick="return kiem_tra_mat_khau();">Thay đổi</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        function kiem_tra() {
            ...
            var emailmoi = document.getElementById('txtEmailmoi').value;      
            if(emailmoi==''){
            ...
            //Khi nhập đủ thông tin thì người dùng sẽ được chuyển đến trang thay_doi_mat_khau.php
            return true;
        }
        </script>            
        <?php 
        ...
        <!-- <?php 
            if(!isset($_POST['txtMatkhau'])){
              exit();
                ...
                // 3. Thực thi câu lệnh truy vấn (mục đích trả về dữ liệu các bạn cần)
                $xac_nhan_email = mysqli_query($ket_noi, $sql);
                $row = mysqli_fetch_array($xac_nhan_email);

                // 4. Xử lý dũ liệu mà các bạn thu được
                $so_luong_email = mysqli_num_rows($xac_nhan_email);
                ...
                else            
                {
                    echo "<script type='text/javascript'>
                        ...
                        lb.innerText = 'Nhập Email mới:';
                        var parent = document.getElementsByClassName('col-md-2')[1];
                        var child = document.getElementsByClassName('mk')[0];
                        parent.replaceChild(lb, child);

                        
                        var email = document.createElement('input');
                        email.setAttribute(\"class\", \"form-control\");
                        email.setAttribute(\"type\", \"email\");
                        email.setAttribute(\"id\", \"txtEmailmoi\");
                        email.setAttribute(\"name\", \"txtEmailmoi\");
                        email.setAttribute(\"placeholder\", \"Nhập email mới\");
                        var parent = document.getElementsByClassName('col-md-6')[2];
                        var child = document.getElementsByClassName('form-control')[1];
                        parent.replaceChild(email, child);


                        var back = '<div class=\"col-md-4\"><button class=\"btn\" href=\"user/profile.php\"> Quay lại </button></div>';
                        var parent = document.getElementsByClassName('row')[5];
                        parent.insertAdjacentHTML('beforeend', back);
                    </script>";
                }
            }
        ;?>    -->
