                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="he_thong_cua_hang.php" class="nav-item nav-link active">HỆ THỐNG CỬA HÀNG</a>                         
                        </div>                   
        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">HỆ THỐNG CỬA HÀNG</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
                            ...
                            <div class="social">
                                ...
                                <div class="col-lg-push-12">
                                    <div class="contact-map">
                                         <iframe src="<?php echo $row['ban_do'] ;?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
